...
SDL_RendererFlip TranslateFlip(Sprite::Flip flip)
{
	...
	default: return SDL_RendererFlip::SDL_FLIP_NONE; 
		break;
	}
}
...

	{
		...
		while (running && !quit)
		{
			...
			while (SDL_PollEvent(&e))
			{
				...
				case SDL_MOUSEMOTION: game.OnMouseMove(e.motion.x, e.motion.y); break;
				case SDL_MOUSEBUTTONDOWN: game.OnMouseKeyDown();  break;
				case SDL_MOUSEBUTTONUP: game.OnMouseKeyUp(); break;
				}
			}
